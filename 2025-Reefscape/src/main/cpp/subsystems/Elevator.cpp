...
Elevator::Elevator(int leftMotor, int rightMotor, int encoder,
...
double
Elevator::getPosition() {  // returns the absolute encoder position with offset
...
void Elevator::Periodic() {
    ...
    frc::SmartDashboard::PutNumber("elevator relative pos",
